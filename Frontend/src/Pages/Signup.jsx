...
useEffect(() => {
  const savedSignup = sessionStorage.getItem("fixkar:signupDraft");
  ...
  try {
    ...
    formik.setValues({
      ...
      acceptedProfessionalPolicy:
        data.acceptedProfessionalPolicy || false,
    });
  ...
  const handleSendOtp = async () => {
    try {
      setWait(true);
      const response = await axios.post(`${server_url}/api/otp/send-email-otp`, {
          ...
          ===================================================== */}
            <div className="col-lg-6 d-none d-lg-block">
              <div className="fixkar-signup-intro">
                ...
                <p>
                  Create your account and get started with Fixkar's smart
                  service platform.
                </p>

                <div className="fixkar-signup-points">
                  <div>
                    <span className="signup-point-number">01</span>
                  ...
                  <div>
                    <span className="signup-point-number">02</span>
                  ...
                  <div>
                    <span className="signup-point-number">03</span>
          ...
          ===================================================== */}
            <div className="col-12 col-sm-10 col-md-8 col-lg-5">
              <div className="fixkar-signup-card">
                  ...
                  <div className="fixkar-signup-field">
                    ...
                    <div
                      className={`fixkar-signup-input ${
                        formik.touched.email && formik.errors.email
                          ? "signup-input-error"
                          : ""
                      } ${emailVerified ? "signup-input-verified" : ""}`}
                    >
                      <MdEmail />
                    ...
                    {!otpSent && (
                      <button
                        ...
                        disabled={!formik.values.email || wait}
                      >
                        {wait ? (
                          <>
                            <ClipLoader size={12} color="#0d6efd" />
                            Sending...
                          </>
                        ) : (
                          "Send OTP"
                ...
                >
                  {loading ? <ClipLoader size={18} /> : <FcGoogle size={21} />}
