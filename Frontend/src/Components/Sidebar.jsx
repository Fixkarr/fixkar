...
const Sidebar = ({ isOpen, onClose, isAdminMode = false }) => {
  ...
  const handleBellClick = async () => {
    try {
      ...
      // Notification read state is non-blocking.
    }
  };
  ...
  return (
    ...
    >
      ...
      <ul className="nav nav-pills flex-column gap-2">
        ...
        {role === "customer" && !adminMode && (
          <>
            <li className="nav-item" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/customer/home" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <GoHome /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Home</span>
              </NavLink>
            </li>
            <li className="nav-item" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/customer/bookings" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <FaRegAddressBook /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Bookings</span>
              </NavLink>
            </li>
            <li className="nav-item" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/customer/hire-professionals" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <MdOutlineEngineering /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Hire</span>
              </NavLink>
            </li>
            <li className="nav-item position-relative" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/customer/messages" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <FiMessageSquare /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Messages</span>
              </NavLink>
              {totalUnreadMessages > 0 && <span className="badge bg-danger position-absolute top-0 start-100 translate-middle">{totalUnreadMessages}</span>}
            </li>
            <li className="nav-item position-relative" style={{ fontSize: "0.5vmax" }} onClick={handleBellClick}>
              <NavLink to="/customer/notifications" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <FiBell /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Notifications</span>
              </NavLink>
              {unreadCount > 0 && <span className="badge bg-danger position-absolute top-0 start-100 translate-middle">{unreadCount}</span>}
            </li>
            <li className="nav-item" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/customer/contact" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <FaHeadset /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Help & Support</span>
              </NavLink>
            </li>
          </>
        )}

        {role === "professional" && !adminMode && (
          <>
            <li className="nav-item" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/professional/home" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <GoHome /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Home</span>
              </NavLink>
            </li>
            <li className="nav-item" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/professional/bookings" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <FaRegAddressBook /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Bookings</span>
              </NavLink>
            </li>
            <li className="nav-item position-relative" style={{ fontSize: "0.5vmax" }} onClick={handleBellClick}>
              <NavLink to="/professional/notifications" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <FiBell /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Notifications</span>
              </NavLink>
              {unreadCount > 0 && <span className="badge bg-danger position-absolute top-0 start-100 translate-middle">{unreadCount}</span>}
            </li>
            <li className="nav-item" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/professional/profile" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <CgProfile /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Profile</span>
              </NavLink>
            </li>
            <li className="nav-item position-relative" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/professional/messages" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <FiMessageSquare /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Messages</span>
              </NavLink>
              {totalUnreadMessages > 0 && <span className="badge bg-danger position-absolute top-0 start-100 translate-middle">{totalUnreadMessages}</span>}
            </li>
            <li className="nav-item position-relative" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/professional/transaction-history" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <MdWorkHistory /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Transaction History</span>
              </NavLink>
            </li>
            <li className="nav-item" style={{ fontSize: "0.5vmax" }}>
              <NavLink to="/professional/contact" className={({ isActive }) => `nav-link d-flex align-items-center justify-content-md-start gap-2 rounded-3 ${isActive ? "bg-white text-primary fw-semibold" : "text-white"}`}>
                <FaHeadset /><span className="d-md-inline" style={{ fontSize: "0.8vmax" }}>Help & Support</span>
              </NavLink>
            </li>
          </>
