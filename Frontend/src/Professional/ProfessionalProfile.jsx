    ...
    try {
      if (navigator.share)
        await navigator.share({
          title: `${ProfessionalDetails.userId.fullName} | FixKar`,
          text: `Hire ${ProfessionalDetails.userId.fullName} on FixKar.`,
          url: profileUrl,
        });
              ...
              <div>
                ...
                {isProfileComplete && (
                  <>
                    ...
                    <p className="mb-3">
                      <ReadMoreText text={ProfessionalDetails?.description} />
                    </p>
                    <hr />
                  </>
                )}
          ...
          {isProfileComplete && (
            <div className="card border-0 shadow-sm rounded-4">
              ...
              >
                <div className="modal-dialog modal-dialog-centered">
                  <div className="modal-content rounded-4">
                    ...
                    <DynamicForm
                      form={form}
                      initialValues={ProfessionalDetails?.charges?.responses}
                    />
                  </div>
                </div>
              </div>
              <div className="card-body">
                ...
                {ChargesDefined && (
                  <FormResponseSummary
                    summary={ProfessionalDetails?.charges?.summary}
                  />
                )}
              </div>
            </div>
            ...
            <div className="card border-0 shadow-sm rounded-4 mb-3">
              ...
              <div className="card-body">
                {ProfessionalDetails.selectedSkills.length === 0 && (
                  <div className="alert alert-warning small py-2">
                    ⚠️ You have not selected any skills yet. Update your skills
                ...
                <div className="mt-3 small text-muted">
                  💡 Keeping your skills updated helps customers find you
                  faster.
                </div>
              </div>
            </div>
