  ...
  return (
    <Routes>
      ...
      <Route element={<DashboardLayout />}>
        ...
        <Route path="/professional/messages" element={role === "professional" ? <Messages/> : <Navigate to="/"/>} />
        <Route path="/professional/chat/:id" element={role === "professional" ? <ChatSection/> : <Navigate to="/"/>}/>
      </Route>
