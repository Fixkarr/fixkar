...
import { adminLogout } from "../AdminController/adminLogout.js";
...
import {
  getAdminBookingById,
  getBookings,
} from "../AdminController/getBookings.js";
...
import {
  deleteAnnouncement,
  getAllAnnouncements,
} from "../AdminController/announcements.controller.js";
...
import { getOfferAnalytics } from "../AdminController/getOfferAnalytics.js";
import {
  deleteEnquiry,
  getEnquiries,
  replyEnquiry,
...
import { updateServiceRequest } from "../AdminController/updateServiceRequest.js";
...
adminRouter.post(
  "/create-service",
  isAdmin,
  adminPermission("super_admin", "content_admin"),
  upload.single("image"),
  addService,
);
adminRouter.post(
...
adminRouter.get(
  "/get-all-customers",
  isAdmin,
  adminPermission("super_admin", "professional_admin"),
  getAllCustomers,
);
adminRouter.get(
...
adminRouter.get(
  "/get-all-bookings",
  isAdmin,
  adminPermission("super_admin", "booking_admin"),
  getBookings,
);
adminRouter.get(
...
adminRouter.post(
  "/accept-professional-application",
  isAdmin,
  adminPermission("super_admin", "professional_admin"),
  acceptApplication,
);

adminRouter.patch('/update-service-request/:serviceRequestId', isAdmin, adminPermission("super_admin", "professional_admin"), updateServiceRequest);
...
// Coupon management. Admin may see the full campaign list; end users never do.
adminRouter.post(
  "/create-offer",
  isAdmin,
  adminPermission("super_admin"),
...
adminRouter.get(
  "/get-enquiries",
  isAdmin,
  adminPermission("super_admin", "support_admin"),
  getEnquiries,
);
adminRouter.post(
  "/reply-enquiry/:enquiryId",
  isAdmin,
  adminPermission("super_admin", "support_admin"),
  replyEnquiry,
);
