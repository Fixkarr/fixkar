...
export const claimCoupon = async ({ userId, couponCode }) => {
  ...
  try {
    ...
    const isProfessionalReward = validated.offer.benefitType === "PROFESSIONAL_REWARD";

    if (isProfessionalReward) {
      // Atomic global-limit reservation: concurrent claims cannot both consume
      // the final coupon slot.
      ...
      await CreditTransaction.create([{
        ...
        credits,
        referenceId: validated.offer._id,
